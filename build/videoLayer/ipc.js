...
function setupVideoLayerIpc(ipcMain, mainWindow) {
    ...
    childWindow.once("show", function () {
        (0, util_2.initVideoLayer)(childWindow.getNativeWindowHandle());
    });
    mainWindow === null || mainWindow === void 0 ? void 0 : mainWindow.once("show", function () {
        childWindow.show();
    });
